...
unordered_map<int, cSkin> cSkinchanger::Skins = unordered_map<int, cSkin>( {
    ...
    make_pair(WEAPON_KNIFE, cSkin(102, -1, KnifeCT, -1, 3, nullptr, 0.0001f)), // Ruby Doppler
    make_pair(WEAPON_KNIFE_T, cSkin(102, -1, KnifeT, -1, 3, nullptr, 0.0001f)), // Fade
    // Gloves
    ...
    // Rifles
    make_pair(WEAPON_AK47, cSkin(316, -1, -1, -1, 0, nullptr, 0.0001f)), // Jaguar
    make_pair(WEAPON_AUG, cSkin(455, -1, -1, -1, 0, nullptr, 0.0001f)), // Akihabara Accept
    make_pair(WEAPON_AWP, cSkin(279, -1, -1, -1, 0, nullptr, 0.0001f)), // Asiimov
    ...
    make_pair(WEAPON_SSG08, cSkin(624, -1, -1, -1, 0, nullptr, 0.0001f)), // Dragonfire
    ...
    make_pair(WEAPON_MP5SD, cSkin(39, -1, -1, -1, 0, nullptr, 0.0001f)), // Bulldozer
