...
public:
    ...
    SkinClass(int paintkit, int seed, short itemDefinition, int stattrack, char* szName, float flWear) :
...
const std::unordered_map<size_t, Item_t> ItemDefIndex = {
    ...
    {WEAPON_KNIFE_URSUS, {"Ursus Knife", "weapon_knife_ursus", "models/weapons/v_knife_ursus.mdl", "knife_ursus"}}, // Ursus Knife
    {WEAPON_KNIFE_GYPSY_JACKKNIFE, {"Navaja Knife", "weapon_knife_gypsy_jackknife", "models/weapons/v_knife_gypsy_jackknife.mdl", "knife_gypsy_jackknife"}}, // Ursus Knife
    {WEAPON_KNIFE_STILETTO, {"Stiletto Knife", "weapon_knife_stiletto", "models/weapons/v_knife_stiletto.mdl", "knife_stiletto"}}, // Ursus Knife
    {WEAPON_KNIFE_WIDOWMAKER, {"Talon Knife", "weapon_knife_widowmaker", "models/weapons/v_knife_widowmaker.mdl", "knife_widowmaker"}} // Ursus Knife
};
